...
/*
    A maioria das funções possui nome autoexplicativo,
    o que dispensa comentários massantes no código. Só
    serão usados comentários em partes estritamente necessárias
                                                                   */
...
public class MainView extends JPanel
{
    ...
    // Inicializa todos os componentes visuais do software, como tamanho da tela, botões e menus    
    void initComponent()
    {
